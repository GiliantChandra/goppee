...
export default function LoginPage({ onLogin }: LoginPageProps) {
  const [email, setEmail] = useState('arjuna.pratama@email.com');
  ...
  return (
    <div style={{
      ...
      {/* Left panel — branding */}
      <div style={{ flex: 1, maxWidth: '480px', padding: '40px', display: 'none' }} className="login-left">
        <div style={{ fontSize: '32px', fontWeight: 800, color: '#f8fafc', letterSpacing: '-1px', marginBottom: '16px' }}>
          🏦 NovaPay
        </div>
        <p style={{ fontSize: '18px', color: '#94a3b8', lineHeight: 1.7 }}>
          Your premium digital banking experience. Secure, fast, and always with you.
        </p>
      </div>
      ...
      <div style={{
        ...
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
          ...
          <div>
            ...
            <input
              ...
              style={{
                ...
                border: '1px solid rgba(99,102,241,0.2)',
                borderRadius: '12px', color: '#f8fafc', fontSize: '14px',
          ...
          <div style={{ textAlign: 'right', marginTop: '-4px' }}>
            <a href="#" style={{ fontSize: '13px', color: '#a5b4fc', textDecoration: 'none' }}
              onMouseEnter={e => ((e.target as HTMLAnchorElement).style.color = '#818cf8')}
              onMouseLeave={e => ((e.target as HTMLAnchorElement).style.color = '#a5b4fc')}
            >
              Forgot password?
            </a>
          </div>
          ...
          <button
            ...
            onMouseLeave={e => { (e.currentTarget as HTMLButtonElement).style.boxShadow = '0 8px 24px rgba(99,102,241,0.3)'; }}
          >
            {loading ? (
              <>
                <div style={{
        ...
        <div style={{
          ...
          <div>
            ...
            <div style={{ fontSize: '11px', color: '#64748b' }}>Enter any password to continue</div>
          </div>
        </div>
      </div>
