...
const navItems: { page: PageName; label: string; icon: string; badge?: string }[] = [
        ...
        >
          ...
          {!collapsed && (
            <div style={{ minWidth: 0 }}>
              <div style={{ fontSize: '13px', fontWeight: 600, color: '#f8fafc', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>Arjuna P.</div>
